...
.bgimg {
  ...
  background-image: url("food\ \(2\).png");
  min-height: 90%;
}
</style>
</head>
...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
  ...
  <div class="w3-display-middle w3-center">
    <span class="w3-text-white w3-hide-small" style="font-size:100px"><br>CARBONARA, SPICY, CREAM CARBONARA, CHEESE</span>
...
<div class="w3-container w3-black w3-padding-64 w3-xxlarge" id="menu">
  <div class="w3-content">
    ...
    <h1 class="w3-center w3-jumbo" style="margin-bottom:64px">THE SAMYANG</h1>
    <div class="w3-row w3-center w3-border w3-border-dark-grey">
      <a href="javascript:void(0)" onclick="openMenu(event, 'Samyang');" id="myLink">
        <div class="w3-row w3-centerw3-col s4 tablink w3-padding-large w3-hover-red">SAMYANG</div>
      </a>
    </div>

    <div id="Samyang" class="w3-container menu w3-padding-32 w3-white">
